    ...
    <div className="relative my-10 flex  flex-col items-center justify-center">
      ...
      <div className="px-4 py-10 md:py-20">
        <h1 className="relative z-10 mx-auto max-w-4xl text-center text-2xl font-bold text-slate-700 md:text-4xl lg:text-7xl dark:text-slate-300">
          {"Schedule your team in minutes.".split(" ").map((word, index) => (
            <motion.span
              key={index}
        ...
        >
          With our tool, you can manage shifts in minutes, not hours. Arrange
          your team effortlessly with our best-in-class, easy-to-use scheduling
          system built to simplify your workflow.
        </motion.p>
        <motion.div
          initial={{
            opacity: 0,
